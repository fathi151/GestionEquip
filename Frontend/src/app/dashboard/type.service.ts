...
ajouterDossier(dossierData: any): Observable<any> {
  return this.httpClient.post<any>(`${this.baseURL}/ajouterDossier`, dossierData, {
    headers: this.getAuthHeaders()
  });
...
getDossiers(): Observable<any[]> {
  return this.httpClient.get<any[]>(`${this.baseURL}/dossiers`, { headers: this.getAuthHeaders() });
}

getDossier(id: number): Observable<any> {
  return this.httpClient.get<any>(`${this.baseURL}/dossiers/${id}`, { headers: this.getAuthHeaders() });
}
